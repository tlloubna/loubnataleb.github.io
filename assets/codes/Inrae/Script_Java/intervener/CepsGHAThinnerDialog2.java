...
/**
 * This dialog box is used to config CepsGHAThinner.
 * 
 * @author Ph. Dreyfus - December 2017 it is almost a copy of
 *         GymnoGHAThinner2Dialog
 */
public class CepsGHAThinnerDialog2 extends AmapDialog implements ActionListener {

	private NumberFormat nf;
	private CepsGHAThinner2 thinner;
	 ...
	 * Constructor
	 */
	public CepsGHAThinnerDialog2(CepsGHAThinner2 thinner) {
		super();
...
//		setTitle(Translator.swap("CepsGHAThinner2"));
	...
	private void okAction() {
		...
		try {
			...
			MessageDialog.print(this, Translator.swap("CepsGHAThinnerDialog2.wrongMinCutG"), e);
			return;
		}
		...
		try {
			...
			MessageDialog.print(this, Translator.swap("CepsGHAThinnerDialog2.wrongType"), e);
			return;
		}
		...
		try {
			...
			MessageDialog.print(this, Translator.swap("CepsGHAThinnerDialog2.wrongFinalG"), e);
			return;
		}
		...
		try {
			...
			MessageDialog.print(this, Translator.swap("CepsGHAThinnerDialog2.wrongExpectedMixComposition"), e);
			return;
		}

		Settings.setProperty ("CepsGHAThinnerDialog2.minCutG", minCutG.getText ().trim ());
		Settings.setProperty ("CepsGHAThinnerDialog2.type", type.getText ().trim ());
		Settings.setProperty ("CepsGHAThinnerDialog2.finalG", finalG.getText ().trim ());
		Settings.setProperty ("CepsGHAThinnerDialog2.expectedMixComposition", expectedMixComposition.getText ().trim ());
	...
	private void createUI() {
		...
		l0.add(new JLabel(Translator.swap("CepsGHAThinnerDialog2.sceneG") + " : "));
		...
		l1.add(new JLabel(Translator.swap("CepsGHAThinnerDialog2.minCutG") + " : "));
		minCutG = new JTextField();
		minCutG.setText (""+Settings.getProperty ("CepsGHAThinnerDialog2.minCutG", 0));
		l1.add(minCutG);
		l1.addStrut0();
		c1.add(l1);

		LinePanel l2 = new LinePanel();
		l2.add(new JLabel(Translator.swap("CepsGHAThinnerDialog2.type") + " : "));
		type = new JTextField();
		type.setText (""+Settings.getProperty ("CepsGHAThinnerDialog2.type", 0));
		l2.add(type);
		l2.addStrut0();
		c1.add(l2);

		LinePanel l3 = new LinePanel();
		l3.add(new JLabel(Translator.swap("CepsGHAThinnerDialog2.finalG") + " : "));
		finalG = new JTextField();
		finalG.setText (""+Settings.getProperty ("CepsGHAThinnerDialog2.finalG", "0"));
		l3.add(finalG);
		l3.addStrut0();
		c1.add(l3);

		LinePanel l4 = new LinePanel();
		l4.add(new JLabel(Translator.swap("CepsGHAThinnerDialog2.expectedMixComposition") + " : "));
		expectedMixComposition = new JTextField();
		expectedMixComposition.setText (""+Settings.getProperty ("CepsGHAThinnerDialog2.expectedMixComposition", ""));
