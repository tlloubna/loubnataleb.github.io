...
import forceps.myscripts.LM_paralle.SimulationFitnessPa;
...
public class ManagementIndvPa {
 ...
 //nb _list
  ...
  public ManagementIndvPa(int inter_max, SimulationFitnessPa simu_fitness) throws Exception {
  ...
  public ManagementIndvPa(List<Double> genome, SimulationFitnessPa simu_fitness, boolean all_exit) throws Exception {
  ...
  public String toString(){
    ...
    public SimulationFitnessPa getSimuFitness(){
