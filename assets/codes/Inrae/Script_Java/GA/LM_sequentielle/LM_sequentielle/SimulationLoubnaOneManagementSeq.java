 ...
 */
  ...
  */
 public class SimulationLoubnaOneManagementSeq {
	 ...
	 private SimulationFitnessSeq simu_fitness;//l'objet qui calcule la fitness 
	 //le main pour executer GA avec ForCEEPS
	 public static void main(String[] args) throws Exception {
		 // init simu : début de la simulation :Initialiser les données.
		 SimulationLoubnaOneManagementSeq simu = new SimulationLoubnaOneManagementSeq(args);
 
		 // init indv: Définir un itinéraire sylvicole=un individu /génome en GA.
		 ManagementIndvSeq indv = new ManagementIndvSeq(simu.genome, simu.simu_fitness, false);
	 }
 
	 /**
	  * Constructor
	  */
	 private SimulationLoubnaOneManagementSeq(String[] args) throws Exception {
		 ...
		 SimulationLoubnaSimulationReaderSeq data = new SimulationLoubnaSimulationReaderSeq();
