...
import java.lang.Math;
  ...
  */
 public class SimulationFitnessPa {
    ...
    * Constructor:
    */
   public SimulationFitnessPa(String working_dir, String output_dir, String setup_file,
                            ...
                            int nb_spe_min, int nb_spe_max, double v_prod_min, double v_prod_max,String Combinaisons_species,int RandomSeed,int nb_process ,int Simulation_Non_viable_fin) {
     // directory use
