 ...
 */
public class SimulationMichelleCommandReader extends FileLoader {
	 ...
	 * Constructor.
	 */
	public SimulationMichelleCommandReader() throws Exception {
		super ();
		//setSpeciesMapId();
	}
	...
	protected void checks() throws Exception {
		...
		//s'assurer que les especes ecrit sont correctent 
